...
def set_priority(id_):
    ...
    if id_.startswith("SABnzbd_nzo"):
        ...
        async def remove_files():
            await sabnzbd_client.remove_file(
                id_,
                to_remove
            )
        ...
        res = aria2.client.change_option(
            id_,
            {"select-file": resume}
        )
        if res == "OK":
...
@app.route("/")
def homepage():
    return "<h1>Visit my channel <a href='https://telegram.me/Reaperzclub'>Reaperzclub</a>on Telegram By <a href='https://telegram.me/acaatr'>Reaper</a></h1>"
